...
public class WebViewClientFlutterApiImpl extends WebViewClientFlutterApi {
    ...
    public void onPageStarted(
        ...
        final Object data = getIdentifierForClient(webViewClient);
        if (data != null) {
            onPageStarted((Long) data, webViewIdentifier, urlArg, callback);
        }
    }
    ...
    public void onPageFinished(
        ...
        final Object data = getIdentifierForClient(webViewClient);
        if (data != null) {
            onPageFinished((Long) data, webViewIdentifier, urlArg, callback);
        }
    }
    ...
    public void urlLoading(
        ...
        final Object data = getIdentifierForClient(webViewClient);
        if (data != null) {
            urlLoading((Long) data, webViewIdentifier, urlArg, callback);
        }
    }
    ...
    public void doUpdateVisitedHistory(
        ...
        final Object data = getIdentifierForClient(webViewClient);
        if (data != null) {
            doUpdateVisitedHistory((Long) data, webViewIdentifier, url, isReload, callback);
        }
    }

    private Object getIdentifierForClient(WebViewClient webViewClient) {
        return instanceManager.getIdentifierForStrongReference(webViewClient);
    }
}
